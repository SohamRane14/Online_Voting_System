<?php
    ...
    $result= $db->query("SELECT * FROM tbMembers WHERE member_id = '$_SESSION[member_id]'")
...
<?php
    ...
    if (isset($_POST['update'])){
        ...
        $sql = $db->query( "UPDATE tbMembers SET first_name='$myFirstName', last_name='$myLastName', email='$myEmail', voter_id = '$myVoterid', password='$newpass' WHERE member_id = '$myId'" )
