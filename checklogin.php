    ...
    <ul class="nospace group">
      <li class="one_half">
		...
		<?php
			...
			$myusername = $db->escape_string($_POST['myusername']);
			$mypassword = $db->escape_string($_POST['mypassword']);

			$sql="SELECT * FROM tbmembers WHERE email='$myusername' and password='$encrypted_mypassword'" or die(mysqli_error($db));
